...
public class IHM {
	...
	public static void inscription(Connection conn) throws SQLException {
		int idSemi=0;
		int idPers=0;
		String tmp="";
	...
	public static void annulation_inscription(Connection conn) throws SQLException {
		int idSemi=0;
		int idPers=0;
		String tmp="";
	...
	public static int creer_personne(Connection conn) throws SQLException {
		int idPers=0;
		long tel=0;
		String prenom="";
		String nom="";
	...
	public static void main(String args[]) throws SQLException{
		...
		do {
			...
			if(tmp.equals("c")){
				...
				IHM.inscription(conn);
			}
			else if(tmp.equals("a")){
				IHM.annulation_inscription(conn);
			}
